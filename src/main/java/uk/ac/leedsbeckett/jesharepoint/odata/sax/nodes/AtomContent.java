 ...
 * @author maber01
 */
@AtomElementMapping( "content" )
public class AtomContent extends AtomNode
{
  String contentType;
  public AtomContent( XmlDocument document, XmlNode parent, String namespace, String name, Attributes attributes ) throws SAXException
  {
